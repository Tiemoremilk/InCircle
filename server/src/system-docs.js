  ...
  return [
    {
      ...
      body: [
        ...
        "邀请与圈子设置｜圈主可以更新圈子名称、公告和介绍，生成入圈码邀请熟人，并管理圈内成员。入圈码只用于加入对应圈子，请不要公开发布；圈主不再保留圈子时，需要先妥善处理圈内资料，再从圈子设置中解散。",
        ...
        "圈内 AI｜圈主开启并完成模型配置后，五个主页面会出现可拖动的 AI 入口。每位成员拥有彼此独立的会话，可新建、切换、删除会话并选择圈内已开放的模型。发送前请阅读服务商提示；输入内容会提供给所选模型服务商，回答由 AI 生成，重要信息需要自行核实。其他成员和圈主不能查看你的聊天正文。",
